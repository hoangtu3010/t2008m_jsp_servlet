...
public class MigrationJava {
    public static final String scanRange = "com.example.hellot2008m";
    ...
    public static void CreateTableFromEntity(Class clazz){
        ...
        StringBuilder dropStringBuilder = new StringBuilder();
        ...
        dropStringBuilder.append(SQLConfig.DROP_TABLE);
        dropStringBuilder.append(SQLConfig.SPACE);
        dropStringBuilder.append(tableName);
